import { loadSnippets, saveSnippet, overwriteSnippet, deleteSnippet } from './snippets';
import { showNotification, announce } from './ui';
...
export function initSnippetsDialog(
  getCode: () => string,
