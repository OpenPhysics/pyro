...
```html
<iframe
  src="https://openlyceum.github.io/pyro/"
  width="100%"
  height="600"
  frameborder="0"
  allow="fullscreen">
...
```html
<iframe
  src="https://openlyceum.github.io/pyro/?header=false&sidebar=false&view=output&example=bouncing-ball&run=true"
  width="100%"
  height="400">
</iframe>
```
...
```html
<iframe
  src="https://openlyceum.github.io/pyro/?theme=light&fontSize=18&example=basic-shapes"
  width="100%"
  height="600">
</iframe>
```
...
```html
<iframe
  src="https://openlyceum.github.io/pyro/?run=true&tab=output&console=true&example=projectile-motion"
  width="100%"
  height="700">
</iframe>
```
...
```html
<iframe
  src="https://openlyceum.github.io/pyro/?header=false&sidebar=false&view=code&example=binary-star"
  width="100%"
  height="500">
</iframe>
```
...
```html
<iframe
  src="https://openlyceum.github.io/pyro/?sidebar=false&view=output&tab=output&run=true&example=spring-mass"
  width="100%"
  height="450">
</iframe>
```
